...
var _extends=Object.assign||function(t){for(var n=1;n<arguments.length;n++){var e=arguments[n];for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i])}return t},_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};!function(t,n){"object"===("undefined"==typeof exports?"undefined":_typeof(exports))&&"undefined"!=typeof module?module.exports=n(require("./PNotify")):"function"==typeof define&&define.amd?define("PNotifyConfirm",["./PNotify"],n):t.PNotifyConfirm=n(PNotify)}(this,function(t){"use strict";t=t&&t.__esModule?t.default:t;var n;function e(t){var n=this._svelte,e=n.component,i=n.ctx;e.handleClick(i.button,t)}function i(t,n,e){var i=Object.create(t);return i.button=n[e],i}function o(t,n){var e,i=(n.confirm||n.prompt)&&r(t,n);return{c:function(){i&&i.c(),e=document.createComment("")},m:function(t,n){i&&i.m(t,n),_(t,e,n)},p:function(n,o){o.confirm||o.prompt?i?i.p(n,o):((i=r(t,o)).c(),i.m(e.parentNode,e)):i&&(i.d(1),i=null)},d:function(t){i&&i.d(t),t&&d(e)}}}function r(t,n){for(var e,o,r,u,c=n.prompt&&s(t,n),a=n.buttons,l=[],p=0;p<a.length;p+=1)l[p]=f(t,i(n,a,p));return{c:function(){e=m("div"),c&&c.c(),o=h("\n    "),r=m("div");for(var t=0;t<l.length;t+=1)l[t].c();r.className=u="\n          ui-pnotify-action-bar\n          "+(n._notice.get()._styles.actionBar?n._notice.get()._styles.actionBar:"")+"\n          "+(n._notice.get()._styles.text?n._notice.get()._styles.text:"")+"\n         svelte-1y9suua",g(r,"justify-content",n.align),e.className="ui-pnotify-confirm"},m:function(n,i){_(n,e,i),c&&c.m(e,null),y(e,o),y(e,r);for(var s=0;s<l.length;s+=1)l[s].m(r,null);t.refs.buttons=r},p:function(n,p){if(p.prompt?c?c.p(n,p):((c=s(t,p)).c(),c.m(e,o)):c&&(c.d(1),c=null),n.buttons||n._notice){a=p.buttons;for(var m=0;m<a.length;m+=1){var y=i(p,a,m);l[m]?l[m].p(n,y):(l[m]=f(t,y),l[m].c(),l[m].m(r,null))}for(;m<l.length;m+=1)l[m].d(1);l.length=a.length}n._notice&&u!==(u="\n          ui-pnotify-action-bar\n          "+(p._notice.get()._styles.actionBar?p._notice.get()._styles.actionBar:"")+"\n          "+(p._notice.get()._styles.text?p._notice.get()._styles.text:"")+"\n         svelte-1y9suua")&&(r.className=u),n.align&&g(r,"justify-content",p.align)},d:function(n){n&&d(e),c&&c.d(),function(t,n){for(var e=0;e<t.length;e+=1)t[e]&&t[e].d(n)}(l,n),t.refs.buttons===r&&(t.refs.buttons=null)}}}function s(t,n){var e,i;function o(t){return t.promptMultiLine?c:u}var r=o(n),s=r(t,n);return{c:function(){e=m("div"),s.c(),e.className=i="\n            ui-pnotify-prompt-bar\n            "+(n._notice.get()._styles.promptBar?n._notice.get()._styles.promptBar:"")+"\n            "+(n._notice.get()._styles.text?n._notice.get()._styles.text:"")+"\n           svelte-1y9suua"},m:function(t,n){_(t,e,n),s.m(e,null)},p:function(n,u){r===(r=o(u))&&s?s.p(n,u):(s.d(1),(s=r(t,u)).c(),s.m(e,null)),n._notice&&i!==(i="\n            ui-pnotify-prompt-bar\n            "+(u._notice.get()._styles.promptBar?u._notice.get()._styles.promptBar:"")+"\n            "+(u._notice.get()._styles.text?u._notice.get()._styles.text:"")+"\n           svelte-1y9suua")&&(e.className=i)},d:function(t){t&&d(e),s.d()}}}function u(t,n){var e,i,o=!1;function r(){o=!0,t.set({promptValue:e.value}),o=!1}function s(n){t.handleKeyPress(n)}return{c:function(){var t,o,u;b(e=m("input"),"input",r),b(e,"keypress",s),t=e,o="type",null==(u="text")?t.removeAttribute(o):t.setAttribute(o,u),e.className=i="\n                ui-pnotify-prompt-input\n                "+(n._notice.get()._styles.input?n._notice.get()._styles.input:"")+"\n                "+n.promptClass+"\n               svelte-1y9suua"},m:function(i,o){_(i,e,o),t.refs.promptSingle=e,e.value=n.promptValue},p:function(t,n){!o&&t.promptValue&&(e.value=n.promptValue),(t._notice||t.promptClass)&&i!==(i="\n                ui-pnotify-prompt-input\n                "+(n._notice.get()._styles.input?n._notice.get()._styles.input:"")+"\n                "+n.promptClass+"\n               svelte-1y9suua")&&(e.className=i)},d:function(n){n&&d(e),v(e,"input",r),v(e,"keypress",s),t.refs.promptSingle===e&&(t.refs.promptSingle=null)}}}function c(t,n){var e,i,o=!1;function r(){o=!0,t.set({promptValue:e.value}),o=!1}function s(n){t.handleKeyPress(n)}return{c:function(){b(e=m("textarea"),"input",r),b(e,"keypress",s),e.rows="5",e.className=i="\n                ui-pnotify-prompt-input\n                "+(n._notice.get()._styles.input?n._notice.get()._styles.input:"")+"\n                "+n.promptClass+"\n               svelte-1y9suua"},m:function(i,o){_(i,e,o),t.refs.promptMulti=e,e.value=n.promptValue},p:function(t,n){!o&&t.promptValue&&(e.value=n.promptValue),(t._notice||t.promptClass)&&i!==(i="\n                ui-pnotify-prompt-input\n                "+(n._notice.get()._styles.input?n._notice.get()._styles.input:"")+"\n                "+n.promptClass+"\n               svelte-1y9suua")&&(e.className=i)},d:function(n){n&&d(e),v(e,"input",r),v(e,"keypress",s),t.refs.promptMulti===e&&(t.refs.promptMulti=null)}}}function a(t,n){var e,i=n.button.text;return{c:function(){e=h(i)},m:function(t,n){_(t,e,n)},p:function(t,n){t.buttons&&i!==(i=n.button.text)&&function(t,n){t.data=""+n}(e,i)},d:function(t){t&&d(e)}}}function l(t,n){var e,i,o=n.button.text;return{c:function(){e=m("noscript"),i=m("noscript")},m:function(t,n){_(t,e,n),e.insertAdjacentHTML("afterend",o),_(t,i,n)},p:function(t,n){t.buttons&&o!==(o=n.button.text)&&(x(e,i),e.insertAdjacentHTML("afterend",o))},d:function(t){t&&(x(e,i),d(e),d(i))}}}function f(t,n){var i,o;function r(t){return t.button.textTrusted?l:a}var s=r(n),u=s(t,n);return{c:function(){i=m("button"),u.c(),i._svelte={component:t,ctx:n},b(i,"click",e),i.type="button",i.className=o="\n              ui-pnotify-action-button\n              "+(n.button.primary?n._notice.get()._styles.btnPrimary?n._notice.get()._styles.btnPrimary:"":n._notice.get()._styles.btn?n._notice.get()._styles.btn:"")+"\n              "+(n.button.addClass?n.button.addClass:"")+"\n             svelte-1y9suua"},m:function(t,n){_(t,i,n),u.m(i,null)},p:function(e,c){s===(s=r(n=c))&&u?u.p(e,n):(u.d(1),(u=s(t,n)).c(),u.m(i,null)),i._svelte.ctx=n,(e.buttons||e._notice)&&o!==(o="\n              ui-pnotify-action-button\n              "+(n.button.primary?n._notice.get()._styles.btnPrimary?n._notice.get()._styles.btnPrimary:"":n._notice.get()._styles.btn?n._notice.get()._styles.btn:"")+"\n              "+(n.button.addClass?n.button.addClass:"")+"\n             svelte-1y9suua")&&(i.className=o)},d:function(t){t&&d(i),u.d(),v(i,"click",e)}}}function p(n){var e,i=this;!function(t,n){t._handlers=P(),t._slots=P(),t._bind=n._bind,t._staged={},t.options=n,t.root=n.root||t,t.store=n.store||t.root.store,n.root||(t._beforecreate=[],t._oncreate=[],t._aftercreate=[])}(this,n),this.refs={},this._state=C(_extends({_notice:null,_options:{}},t.modules.Confirm.defaults),n.data),this._intro=!0,document.getElementById("svelte-1y9suua-style")||((e=m("style")).id="svelte-1y9suua-style",e.textContent=".ui-pnotify-action-bar.svelte-1y9suua,.ui-pnotify-prompt-bar.svelte-1y9suua{margin-top:5px;clear:both}.ui-pnotify-action-bar.svelte-1y9suua{display:flex;flex-wrap:wrap;justify-content:flex-end}.ui-pnotify-prompt-input.svelte-1y9suua{margin-bottom:5px;display:block;width:100%}.ui-pnotify-confirm-mx-1.svelte-1y9suua{margin:0 5px}.ui-pnotify.ui-pnotify-with-icon .ui-pnotify-confirm-ml.svelte-1y9suua{margin-left:24px}[dir=rtl] .ui-pnotify.ui-pnotify-with-icon .ui-pnotify-confirm-ml.svelte-1y9suua{margin-right:24px;margin-left:0}",y(document.head,e)),this._fragment=o(this,this._state),this.root._oncreate.push(function(){(function(){this.fire("init",{module:this})}).call(i),i.fire("update",{changed:k({},i._state),current:i._state})}),n.target&&(this._fragment.c(),this._mount(n.target,n.anchor),N(this))}function m(t){return document.createElement(t)}function y(t,n){t.appendChild(n)}function _(t,n,e){t.insertBefore(n,e)}function d(t){t.parentNode.removeChild(t)}function h(t){return document.createTextNode(t)}function g(t,n,e){t.style.setProperty(n,e)}function b(t,n,e,i){t.addEventListener(n,e,i)}function v(t,n,e,i){t.removeEventListener(n,e,i)}function x(t,n){for(;t.nextSibling&&t.nextSibling!==n;)t.parentNode.removeChild(t.nextSibling)}function C(t,n){for(var e in n)t[e]=n[e];return t}function k(t,n){for(var e in n)t[e]=1;return t}function N(t){t._lock=!0,S(t._beforecreate),S(t._oncreate),S(t._aftercreate),t._lock=!1}function B(){}function P(){return Object.create(null)}function S(t){for(;t&&t.length;)t.shift()()}return C(p.prototype,{destroy:function(t){this.destroy=B,this.fire("destroy"),this.set=B,this._fragment.d(!1!==t),this._fragment=null,this._state={}},get:function(){return this._state},fire:function(t,n){var e=t in this._handlers&&this._handlers[t].slice();if(!e)return;for(var i=0;i<e.length;i+=1){var o=e[i];if(!o.__calling)try{o.__calling=!0,o.call(this,n)}finally{o.__calling=!1}}},on:function(t,n){var e=this._handlers[t]||(this._handlers[t]=[]);return e.push(n),{cancel:function(){var t=e.indexOf(n);~t&&e.splice(t,1)}}},set:function(t){if(this._set(C({},t)),this.root._lock)return;N(this.root)},_set:function(t){var n=this._state,e={},i=!1;for(var o in t=C(this._staged,t),this._staged={},t)this._differs(t[o],n[o])&&(e[o]=i=!0);if(!i)return;this._state=C(C({},n),t),this._recompute(e,this._state),this._bind&&this._bind(e,this._state);this._fragment&&(this.fire("state",{changed:e,current:this._state,previous:n}),this._fragment.p(e,this._state),this.fire("update",{changed:e,current:this._state,previous:n}))},_stage:function(t){C(this._staged,t)},_mount:function(t,n){this._fragment[this._fragment.i?"i":"m"](t,n||null)},_differs:function(t,n){return t!=t?n==n:t!==n||t&&"object"===(void 0===t?"undefined":_typeof(t))||"function"==typeof t}}),C(p.prototype,{initModule:function(t){this.set(t)},afterOpen:function(){if(this.get().prompt&&!1!==this.get().focus)this.get().promptMultiLine?this.refs.promptMulti.focus():this.refs.promptSingle.focus();else if(this.get().confirm&&(!0===this.get().focus||null===this.get().focus&&this.get()._options.stack.modal)){var t=this.get().buttons;if(t.length){for(var n=t.length-1;n>=0&&!t[n].promptTrigger;)n--;this.refs.buttons.children[n].focus()}}},handleClick:function(t,n){t.click&&t.click(this.get()._notice,this.get().prompt?this.get().promptValue:null,n)},handleKeyPress:function(t){if(13===t.keyCode&&!t.shiftKey){t.preventDefault();for(var n=this.get().buttons,e=0;e<n.length;e++)n[e].promptTrigger&&n[e].click&&n[e].click(this.get()._notice,this.get().prompt?this.get().promptValue:null,t)}}}),p.prototype._recompute=B,(n=p).key="Confirm",n.defaults={confirm:!1,prompt:!1,promptClass:"",promptValue:"",promptMultiLine:!1,focus:null,align:"flex-end",buttons:[{text:"Ok",textTrusted:!1,addClass:"",primary:!0,promptTrigger:!0,click:function(t,n){t.close(),t.fire("pnotify.confirm",{notice:t,value:n})}},{text:"Cancel",textTrusted:!1,addClass:"",click:function(t){t.close(),t.fire("pnotify.cancel",{notice:t})}}]},t.modules.Confirm=n,t.modulesAppendContainer.push(n),_extends(t.styling.brighttheme,{actionBar:"",promptBar:"",btn:"",btnPrimary:"brighttheme-primary",input:""}),_extends(t.styling.bootstrap3,{actionBar:"ui-pnotify-confirm-ml",promptBar:"ui-pnotify-confirm-ml",btn:"btn btn-default ui-pnotify-confirm-mx-1",btnPrimary:"btn btn-default ui-pnotify-confirm-mx-1 btn-primary",input:"form-control"}),_extends(t.styling.bootstrap4,{actionBar:"ui-pnotify-confirm-ml",promptBar:"ui-pnotify-confirm-ml",btn:"btn btn-secondary mx-1",btnPrimary:"btn btn-primary mx-1",input:"form-control"}),t.styling.material||(t.styling.material={}),_extends(t.styling.material,{actionBar:"",promptBar:"",btn:"",btnPrimary:"ui-pnotify-material-primary",input:""}),p});
var _extends=Object.assign||function(i){for(var t=1;t<arguments.length;t++){var e=arguments[t];for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&(i[o]=e[o])}return i},_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(i){return typeof i}:function(i){return i&&"function"==typeof Symbol&&i.constructor===Symbol&&i!==Symbol.prototype?"symbol":typeof i};!function(i,t){"object"===("undefined"==typeof exports?"undefined":_typeof(exports))&&"undefined"!=typeof module?module.exports=t(require("./PNotify")):"function"==typeof define&&define.amd?define("PNotifyMobile",["./PNotify"],t):i.PNotifyMobile=t(PNotify)}(this,function(i){"use strict";i=i&&i.__esModule?i.default:i;var t,e={initModule:function(i){var t=this;this.set(i);var e=this.get()._notice,o=null,n=null,s=null,r=null,l="left",f="X",a="Width";e.on("touchstart",function(i){if(t.get().swipeDismiss){var n=e.get().stack;if(!1!==n)switch(n.dir1){case"up":case"down":l="left",f="X",a="Width";break;case"left":case"right":l="top",f="Y",a="Height"}o=i.touches[0]["screen"+f],s=e.refs.elem["scroll"+a],r=window.getComputedStyle(e.refs.elem).opacity,e.refs.container.style[l]=0}}),e.on("touchmove",function(i){if(o&&t.get().swipeDismiss){var a=i.touches[0]["screen"+f];n=a-o;var p=(1-Math.abs(n)/s)*r;e.refs.elem.style.opacity=p,e.refs.container.style[l]=n+"px"}}),e.on("touchend",function(){if(o&&t.get().swipeDismiss){if(e.refs.container.classList.add("ui-pnotify-mobile-animate-left"),Math.abs(n)>40){var i=n<0?-2*s:2*s;e.refs.elem.style.opacity=0,e.refs.container.style[l]=i+"px",e.close()}else e.refs.elem.style.removeProperty("opacity"),e.refs.container.style.removeProperty(l);o=null,n=null,s=null,r=null}}),e.on("touchcancel",function(){o&&t.get().swipeDismiss&&(e.refs.elem.style.removeProperty("opacity"),e.refs.container.style.removeProperty(l),o=null,n=null,s=null,r=null)}),this.doMobileStyling()},update:function(){this.doMobileStyling()},beforeOpen:function(){window.addEventListener("resize",this.get()._doMobileStylingBound)},afterClose:function(){if(window.removeEventListener("resize",this.get()._doMobileStylingBound),this.get().swipeDismiss){var i=this.get()._notice;i.refs.elem.style.removeProperty("opacity"),i.refs.container.style.removeProperty("left"),i.refs.container.style.removeProperty("top")}},doMobileStyling:function(){var i=this.get()._notice,t=i.get().stack;if(this.get().styling){if(!1!==t)switch(window.innerWidth<=480?(t.mobileOrigSpacing1||(t.mobileOrigSpacing1=t.spacing1),t.spacing1=0,t.mobileOrigFirstpos1||(t.mobileOrigFirstpos1=t.firstpos1),t.firstpos1=0,t.mobileOrigSpacing2||(t.mobileOrigSpacing2=t.spacing2),t.spacing2=0,t.mobileOrigFirstpos2||(t.mobileOrigFirstpos2=t.firstpos2),t.firstpos2=0):(t.mobileOrigSpacing1&&(t.spacing1=t.mobileOrigSpacing1,delete t.mobileOrigSpacing1),t.mobileOrigFirstpos1&&(t.firstpos1=t.mobileOrigFirstpos1,delete t.mobileOrigFirstpos1),t.mobileOrigSpacing2&&(t.spacing2=t.mobileOrigSpacing2,delete t.mobileOrigSpacing2),t.mobileOrigFirstpos2&&(t.firstpos2=t.mobileOrigFirstpos2,delete t.mobileOrigFirstpos2)),t.dir1){case"down":i.addModuleClass("ui-pnotify-mobile-top");break;case"up":i.addModuleClass("ui-pnotify-mobile-bottom");break;case"left":i.addModuleClass("ui-pnotify-mobile-right");break;case"right":i.addModuleClass("ui-pnotify-mobile-left")}i.addModuleClass("ui-pnotify-mobile-able")}else i.removeModuleClass("ui-pnotify-mobile-able","ui-pnotify-mobile-top","ui-pnotify-mobile-bottom","ui-pnotify-mobile-right","ui-pnotify-mobile-left"),!1!==t&&(t.mobileOrigSpacing1&&(t.spacing1=t.mobileOrigSpacing1,delete t.mobileOrigSpacing1),t.mobileOrigFirstpos1&&(t.firstpos1=t.mobileOrigFirstpos1,delete t.mobileOrigFirstpos1),t.mobileOrigSpacing2&&(t.spacing2=t.mobileOrigSpacing2,delete t.mobileOrigSpacing2),t.mobileOrigFirstpos2&&(t.firstpos2=t.mobileOrigFirstpos2,delete t.mobileOrigFirstpos2))}};function o(){var i,t,e,o=(i="style",document.createElement(i));o.id="svelte-49u8sj-style",o.textContent="[ui-pnotify] .ui-pnotify-container{position:relative}[ui-pnotify] .ui-pnotify-mobile-animate-left{transition:left .1s ease}[ui-pnotify] .ui-pnotify-mobile-animate-top{transition:top .1s ease}@media(max-width: 480px){[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able{font-size:1.2em;-webkit-font-smoothing:antialiased;-moz-font-smoothing:antialiased;-ms-font-smoothing:antialiased;font-smoothing:antialiased}body > [ui-pnotify].ui-pnotify.ui-pnotify-mobile-able{position:fixed}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-top,[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-bottom{width:100% !important}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-left,[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-right{height:100% !important}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able .ui-pnotify-shadow{-webkit-box-shadow:none;-moz-box-shadow:none;box-shadow:none}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-top .ui-pnotify-shadow{border-bottom-width:5px}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-bottom .ui-pnotify-shadow{border-top-width:5px}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-left .ui-pnotify-shadow{border-right-width:5px}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-right .ui-pnotify-shadow{border-left-width:5px}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able .ui-pnotify-container{-webkit-border-radius:0;-moz-border-radius:0;border-radius:0}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-top .ui-pnotify-container,[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-bottom .ui-pnotify-container{width:auto !important}[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-left .ui-pnotify-container,[ui-pnotify].ui-pnotify.ui-pnotify-mobile-able.ui-pnotify-mobile-right .ui-pnotify-container{height:100% !important}}",t=document.head,e=o,t.appendChild(e)}function n(t){var e=this;!function(i,t){i._handlers=a(),i._slots=a(),i._bind=t._bind,i._staged={},i.options=t,i.root=t.root||i,i.store=t.store||i.root.store,t.root||(i._beforecreate=[],i._oncreate=[],i._aftercreate=[])}(this,t),this._state=r(_extends({_notice:null,_options:{}},i.modules.Mobile.defaults),t.data),this._intro=!0,document.getElementById("svelte-49u8sj-style")||o(),this._fragment=(this._state,{c:s,m:s,p:s,d:s}),this.root._oncreate.push(function(){(function(){this.set({_doMobileStylingBound:this.doMobileStyling.bind(this)})}).call(e),e.fire("update",{changed:l({},e._state),current:e._state})}),t.target&&(this._fragment.c(),this._mount(t.target,t.anchor),f(this))}function s(){}function r(i,t){for(var e in t)i[e]=t[e];return i}function l(i,t){for(var e in t)i[e]=1;return i}function f(i){i._lock=!0,p(i._beforecreate),p(i._oncreate),p(i._aftercreate),i._lock=!1}function a(){return Object.create(null)}function p(i){for(;i&&i.length;)i.shift()()}return r(n.prototype,{destroy:function(i){this.destroy=s,this.fire("destroy"),this.set=s,this._fragment.d(!1!==i),this._fragment=null,this._state={}},get:function(){return this._state},fire:function(i,t){var e=i in this._handlers&&this._handlers[i].slice();if(!e)return;for(var o=0;o<e.length;o+=1){var n=e[o];if(!n.__calling)try{n.__calling=!0,n.call(this,t)}finally{n.__calling=!1}}},on:function(i,t){var e=this._handlers[i]||(this._handlers[i]=[]);return e.push(t),{cancel:function(){var i=e.indexOf(t);~i&&e.splice(i,1)}}},set:function(i){if(this._set(r({},i)),this.root._lock)return;f(this.root)},_set:function(i){var t=this._state,e={},o=!1;for(var n in i=r(this._staged,i),this._staged={},i)this._differs(i[n],t[n])&&(e[n]=o=!0);if(!o)return;this._state=r(r({},t),i),this._recompute(e,this._state),this._bind&&this._bind(e,this._state);this._fragment&&(this.fire("state",{changed:e,current:this._state,previous:t}),this._fragment.p(e,this._state),this.fire("update",{changed:e,current:this._state,previous:t}))},_stage:function(i){r(this._staged,i)},_mount:function(i,t){this._fragment[this._fragment.i?"i":"m"](i,t||null)},_differs:function(i,t){return i!=i?t==t:i!==t||i&&"object"===(void 0===i?"undefined":_typeof(i))||"function"==typeof i}}),r(n.prototype,e),n.prototype._recompute=s,(t=n).key="Mobile",t.defaults={swipeDismiss:!0,styling:!0},t.init=function(i){return new t({target:document.body})},i.modules.Mobile=t,n});
...
function highlightInvalidFields(form, fieldnames, errorMessages) {
	$(form).find('input, select, textarea').each(function() {
		...
		if(index == -1) {
			...
			displayErrorMessage($(this), errorMessages[index]);
		}
	});
}
...
function displayErrorMessage(element, message) {
    ...
    var errorHtml = `<span class="error-message">${message}</span>`;
...
function showSuccess(caption, successList, callback) {
	...
	alertify.success('<div><strong><i class="fa fa-check"></i> '+caption+'</strong></div>' + successListMsgs);
...
function showError(caption, errorList) {
	...
	alertify.error('<div><strong><i class="fa fa-exclamation-triangle"></i> '+caption+'</strong></div>' + errorListMsgs);
}
...
function showLoader() {
	$('.loader-section').stop().show();
}

function hideLoader() {
    $('.loader-section').stop().hide();
}
